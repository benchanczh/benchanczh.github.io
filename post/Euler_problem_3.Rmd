...
description: "Euler Problem 3: Largest Prime Factor"
---
...
prime_factors <- function(n) {
  ...
  prime_numbers <- all_prime(floor(sqrt(n)))  # Find out all primes no greater than square root of n
...
def prime_factors(n):
    ...
    prime_numbers = all_prime(math.floor(math.sqrt(n)))  # Find out all primes no greater than square root of n
